                    ...
                    <ul>
                        <li>
                            <a style="text-decoration: none;" href="#">
                                <span class="me-2"><img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/team_page/modal.png"
                                        alt="modal.png"></span>
                                Shamim Al Hasan
                            </a>
                        </li>
                ...
                <div class="team_card__start bg-white p-3 rounded mt-3">
                    <div class="team_card__header d-flex justify-content-between align-items-center">
                        <div class="team_card__header__left">
                            <span class="me-2">
                                <img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/avatar/team.png" alt="team.png">
                            </span>
                            <p>Web Development</p>
                        </div>
                    ...
                    <div class="team_card__avatar">
                        <ul>
                            <li>
                                <a href="#"> <img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/team_page/avatar.png"
                                        alt="avatar.png"></a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/team_page/avatar2.png" alt="avatar2.png">
                                </a>
                            </li>
                            <li>
                                <a href="#"> <img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/team_page/avatar3.png"
                                        alt="avatar3.png"></a>
                            </li>
                            <li>
                                <a href="#"><img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/team_page/avatar4.png"
                                        alt="avatar4.png"></a>
                            </li>
                            <li>
                                <a href="#"><img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/team_page/avatar5.png"
                                        alt="avatar5.png"></a>
                            </li>
                        </ul>
                    </div>
...
<?php echo $__env->make('layouts.app_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rajiur Rahman\Desktop\crm2\SoCloseSociety-CRM\resources\views/admin/team.blade.php ENDPATH**/ ?>