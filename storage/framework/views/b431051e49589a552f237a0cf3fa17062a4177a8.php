...
<div class="container-fluid px-4 conatiners">
                                ...
                                <div class="mb-3">
                                    ...
                                    <button class="d-block w-100 upload_field rounded form-control">
                                        <div class="content d-flex justify-content-between">
                                            ...
                                            <img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/profile_page/upload.svg"
                                                alt="upload.svg">
                                        </div>
                                    </button>
                                </div>
    ...
    <div class="profile_banner_part mt-3 bg-white">
        <div class="profile_banner_part_banner overflow-hidden">
            <img class="h-100 w-100" src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/profile_page/banner.jpg" alt="banner.jpg">
        </div>
        <div class="profile_banner_part__profile_img text-center bg-white p-3">
            <div class="profile_banner_part__profile_img__image">
                <img class="w-100" src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/profile_page/profile.png" alt="profile.png">
            </div>
            <div class="profile_banner_part__profile_img__info">
                ...
                <div class="edit_icon pointer" data-bs-toggle="modal" data-bs-target="#primary-infoModal"
                    ...
                    <img src="<?php echo e(asset('dashboard_assets/assets')); ?>/images/profile_page/edit-icon.svg" alt="edit-icon.svg">
                </div>
            </div>
        </div>
        <hr class="m-0 p-0">
...
<?php echo $__env->make('layouts.app_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rajiur Rahman\Desktop\Alhamdulillah\crm\resources\views/admin/settings.blade.php ENDPATH**/ ?>