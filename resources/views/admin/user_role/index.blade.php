            ...
            <tbody>
                @if($roles->count() > 0)
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="{{ route('user_role.show', $item->id) }}" style="text-decoration: none">{{$item->role}}</a>
                        </td>
                        <td>
                            @php
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li class="mb-1"><a style="cursor: pointer" class="dropdown-item" href="{{ route('user_role.show', $item->id) }}"><i class="fa-solid fa-eye" class="mr-50"></i> Show</a></li>
