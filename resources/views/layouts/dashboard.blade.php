        ...
        <div class="row row-cols-xxl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-3 my-2">
            <div class="col">
                <div
                    ...
                    <img src="{{ asset('dashboard_assets/assets') }}/images/content_icon/tickets.svg"
            ...
            <div class="col">
                <div
                    class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded cards">
                    <img src="{{ asset('dashboard_assets/assets') }}/images/content_icon/open.svg"
            ...
            <div class="col">
                <div
                    class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded cards">
                    <img src="{{ asset('dashboard_assets/assets') }}/images/content_icon/closed.svg"
            ...
            <div class="col">
                <div
                    class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded cards">
                    <img src="{{ asset('dashboard_assets/assets') }}/images/content_icon/solved.svg"
            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        @endphp
                        You Are Logged in as a {{ $role_name }}
                    </div>
                </div>
            </div>
        </div>
